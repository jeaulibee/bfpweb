...
<div class="modern-bg">
    <div class="modern-card">
        ...
        <form method="POST" action="{{ route('admin.staff.update', $staff->id) }}" class="modern-form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <!-- Image Preview -->
                <div id="image-preview" class="image-preview-container" style="display: {{ $staff->profile_picture ? 'inline-block' : 'none' }};">
                    <img id="preview" class="image-preview" src="{{ $staff->profile_picture ? asset('storage/' . $staff->profile_picture) : '' }}">
